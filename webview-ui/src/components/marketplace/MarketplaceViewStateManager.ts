 ...
 *
 * This class manages the state for the marketplace view in the Bolt Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Bolt Code extensions interface
