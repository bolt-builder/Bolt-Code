...
const ZOO_CODE_TOKEN_KEY = "bolt-code-session-token"
const ZOO_CODE_USER_NAME_KEY = "bolt-code-user-name"
const ZOO_CODE_USER_EMAIL_KEY = "bolt-code-user-email"
const ZOO_CODE_USER_IMAGE_KEY = "bolt-code-user-image"
