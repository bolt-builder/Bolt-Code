 ...
 * Maps to archive names at https://github.com/bolt-builder/sembleexec/releases
 *
...
const DOWNLOAD_BASE_URL = `https://github.com/bolt-builder/sembleexec/releases/download/${SEMBLE_VERSION}`
