...
describe("importRooTaskHistory", () => {
	...
	it("resolves Roo and Zoo storage roots from extension domains and configured custom paths", async () => {
		const zooGlobalStoragePath = path.join(tempRoot, "globalStorage", "zoocodeorganization.bolt-code")
		...
		expect(result.zooExtensionDomain).toBe("bolt-builder.bolt-code")
