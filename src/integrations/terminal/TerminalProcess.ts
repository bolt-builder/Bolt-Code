...
export class TerminalProcess extends BaseTerminalProcess {
	...
	public override async run(command: string) {
		...
		// PS-specific counter/sleep workarounds.  Prefer the Bolt Code profile
	...
	private prepareCommandForShellIntegration(
		...
		//
		// Try the Bolt Code profile first; if unset, fall back to the VS Code default
		// profile so users who haven't configured a Bolt Code profile override still
