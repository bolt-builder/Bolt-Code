	...
	describe("createMessage", () => {
		...
		it("should handle API errors", async () => {
			...
			await expect(collectStream(stream)).rejects.toThrow(
				"Please check the LM Studio developer logs to debug what went wrong. You may need to load the model with a larger context length to work with Bolt Code's prompts.",
			)
		})
	})
