...
### 3. Únete a la comunidad de Bolt Code
...
- **Compruebe las incidencias existentes**: busque en [Incidencias de GitHub](https://github.com/bolt-builder/Bolt-Code/issues).
...
- Consulta la [página de GitHub Issues](https://github.com/bolt-builder/Bolt-Code/issues) para ver las issues.
- Para la documentación, visite [Documentos de Bolt Code](https://github.com/bolt-builder/Bolt-Code-Docs).

### Informar de errores

- Compruebe primero si existen informes.
- Cree un nuevo error utilizando la [plantilla "Informe de error"](https://github.com/bolt-builder/Bolt-Code/issues/new/choose) con:
    - Pasos de reproducción claros y numerados
    - Resultado esperado vs. real
    - Versión de Bolt Code (obligatorio); proveedor/modelo de API si es relevante
- **Problemas de seguridad**: informe de forma privada a través de [avisos de seguridad](https://github.com/bolt-builder/Bolt-Code/security/advisories/new).
...
Al contribuir, acepta que sus contribuciones se licenciarán bajo la Licencia Apache 2.0, de acuerdo con la licencia de Bolt Code.
