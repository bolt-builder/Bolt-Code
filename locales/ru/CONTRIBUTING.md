...
### 3. Присоединяйся к сообществу Bolt Code
...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/bolt-builder/Bolt-Code/issues).
...
- Проверь [страницу GitHub Issues](https://github.com/bolt-builder/Bolt-Code/issues), чтобы найти issues.
- Для документации посетите [Документацию Bolt Code](https://github.com/bolt-builder/Bolt-Code-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/bolt-builder/Bolt-Code/issues/new/choose) с:
    - Четкими, пронумерованными шагами воспроизведения
    - Ожидаемым и фактическим результатом
    - Версией Bolt Code (обязательно); поставщиком/моделью ИИ, если применимо
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/bolt-builder/Bolt-Code/security/advisories/new).
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием Bolt Code.
