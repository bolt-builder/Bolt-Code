...
### 3. Bergabunglah dengan Komunitas Bolt Code
...
- **Periksa masalah yang ada**: Cari di [Masalah GitHub](https://github.com/bolt-builder/Bolt-Code/issues).
...
- Periksa [halaman GitHub Issues](https://github.com/bolt-builder/Bolt-Code/issues) untuk melihat issues.
- Untuk dokumentasi, kunjungi [Dokumentasi Bolt Code](https://github.com/bolt-builder/Bolt-Code-Docs).

### Melaporkan Bug

- Periksa laporan yang ada terlebih dahulu.
- Buat bug baru menggunakan [template "Laporan Bug"](https://github.com/bolt-builder/Bolt-Code/issues/new/choose) dengan:
    - Langkah-langkah reproduksi yang jelas dan bernomor
    - Hasil yang diharapkan vs aktual
    - Versi Bolt Code (wajib); penyedia/model API jika relevan
- **Masalah keamanan**: Laporkan secara pribadi melalui [saran keamanan](https://github.com/bolt-builder/Bolt-Code/security/advisories/new).
...
Dengan berkontribusi, Anda setuju bahwa kontribusi Anda akan dilisensikan di bawah Lisensi Apache 2.0, sesuai dengan lisensi Bolt Code.
