---
description: "Prepare a new release of the Bolt Code extension"
...
4. Summarize the changes. If the user did not specify a release type, ask whether this should be a major, minor, or patch release.
    ...
    - Bolt Code nightlies should stay on `major.ODD_NUMBER.patch` and use a large patch number for CI-generated pre-releases.
...
5. Review and update the Marketplace-facing root `README.md`.
    ...
    - Check for stale upstream Roo Code wording that should now say Bolt Code.
